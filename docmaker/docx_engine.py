#!/usr/bin/env python3
"""
Motor de substituicao para o Gerador de Declaracao.

Responsavel por:
- Carregar o modelo DOCX.
- Aplicar substituicoes com tentativas em runs e fallback reescrevendo o paragrafo inteiro.
...
def _replace_in_paragraph(paragraph, text_repl: TextReplacements, regex_repl: RegexReplacements) -> None:
    # Primeiro: tentar substituir run a run para preservar formatacao.
    ...
    # Fallback: se ainda existe algum alvo ou regex a aplicar, reescreve o paragrafo.
