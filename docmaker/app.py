#!/usr/bin/env python3
"""
GUI em Tkinter para gerar declaracoes a partir de um DOCX modelo.
"""
...
class App(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Gerador de Declaracao")
    ...
    def _build_widgets(self) -> None:
        ...
        notebook.add(tab_saida, text="3. Saida")
        ...
        ttk.Label(frm_fields, text="Papel/Titulo:").grid(row=0, column=0, sticky="e", padx=4, pady=4)
        ttk.Combobox(
            frm_fields,
        ...
        labels = [
            ...
            ("Titulo do TCC:", self.titulo_var),
            ("Autor do TCC:", self.autor_var),
            ("Responsavel (assinatura):", self.resp_var),
            ("Cargo do responsavel:", self.cargo_var),
        ...
        ttk.Label(frm_saida, text="Pasta de saida:").pack(side="left")
    ...
    def _on_generate(self) -> None:
        try:
            ...
            if not template_path.exists():
                messagebox.showerror("Erro", f"Modelo nao encontrado: {template_path}")
                return
